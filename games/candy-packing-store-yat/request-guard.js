...
(function (global) {
  ...
  var AD_HOST_SUFFIXES = [
    ...
    "game-cdn.poki.net",
    "game-cdn.poki.org",
    // 掐断 CrazyGames 官方 SDK（含 SiteLock 域名锁脚本）的加载：
    // framework 会用 fetch/XHR 把 sdk.crazygames.com 的 SDK 拉下来 eval，
    // 真 SDK 用自己的 window.location 跑 SiteLock 会 Code 3 把游戏锁死。
    // 拦截后 window.CrazyGames 保持本地桩，sitelock.check 返回 code:1，游戏正常解锁。
    "crazygames.com",
    "sdk.crazygames.com",
    "api.crazygames.com",
  ];
