(function() {
  ...
  window.PokiSDK = {
    ...
    gameplayStart: _pn,
    gameplayStop: _pn,
    commercialBreak: function() { console.log('commercialBreak'); return Promise.resolve(true); },
    rewardedBreak: function() { console.log('rewardedBreak'); return Promise.resolve(true); },
    displayAd: _pn,
    destroyAd: _pn,
    setDebug: _pn,
