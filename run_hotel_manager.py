...
DEFAULT_GAME_DIR = REPO_ROOT / "hotel-manager"
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="My Perfect Hotel (hotel-manager) 本地启动器（Unity WebGL 静态站）",
    )
    parser.add_argument("--dir", default=str(DEFAULT_GAME_DIR), help="游戏目录（默认: hotel-manager）")
