...
ClassicNetworkManager.prototype.initialize = async function () {
    this.app.isMobile = this.app.touch != null;
...
ClassicNetworkManager.prototype.setMenu = function (state = true) {
    if (state) {
        if (this.app.classicLocalPlayer)
            this.app.classicLocalPlayer.stopMovement();
