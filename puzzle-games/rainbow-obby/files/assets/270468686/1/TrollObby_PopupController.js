/*TrollObbyPopupController script that handles rewarded popup panels by Emre Şahin - emolingo games */
var TrollObbyPopupController = pc.createScript('trollObbyPopupController');
// initialize code called once per entity
TrollObbyPopupController.prototype.initialize = function () {
    this.app.trollObbyPopupController = this;
...
TrollObbyPopupController.prototype.hidePopup = function () {
...
TrollObbyPopupController.prototype.showPopup = function (title, desc, isYesNoQuestion, callerEntity, yesEvent, noEvent, data, isAd, skipOldEventThing = false) {
    ...
    this.closeButton.button.on('click', function (event) {
        if (noEvent !== "closePopup") {
            if (this.oldNoEvent && !skipOldEventThing) {
    ...
    this.yesButton.button.on('click', function (event) {
        if (this.oldYesEvent && !skipOldEventThing) {
...
TrollObbyPopupController.prototype.setTween = function (state) {
...
TrollObbyPopupController.prototype.removeListeners = function () {
