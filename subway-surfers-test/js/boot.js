...
function dispatchSubmitScore()
{
    document.dispatchEvent(new CustomEvent('submitScore', { detail: submitScore }));
}

document.addEventListener('requestSubmitScore', function ()
{
    if (submitScore) dispatchSubmitScore();
});
